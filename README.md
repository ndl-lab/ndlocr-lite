...
インストール不要でブラウザから直接 OCR を実行できる **Web 版** を提供しています。

- **公開 URL**: リリース後に更新予定
- **対応ブラウザ**: Chrome/Edge 119 以降、Firefox 120 以降、Safari 17 以降
- **モデルサイズ**: 初回アクセス時に約 150 MB をダウンロードします（2 回目以降はオフラインでも動作）
- **プライバシー**: 画像データは外部サーバに送信されません。OCR 処理はすべてブラウザ内で完結します

詳しい使い方は [docs/user-guide-web.md](./docs/user-guide-web.md) を、開発者向け情報は [ndlocr-lite-web/README.md](./ndlocr-lite-web/README.md) をご覧ください。
