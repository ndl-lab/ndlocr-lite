...
| # | タイトル | ファイル | 主なゴール |
|---|---|---|---|
| 0 | 調査・前提整理 | [phase-0-feasibility.md](./phase-0-feasibility.md) | 技術選定 / 依存調査 / DoD 定義 |
| 1 | Python コアのブラウザ互換化 | [phase-1-python-refactor.md](./phase-1-python-refactor.md) | `opencv` / `onnxruntime` 依存除去、純関数化、`ndlocr_web` パッケージ新設 |
| 2 | モデル配信 & onnxruntime-web 統合 | [phase-2-models-and-ort-web.md](./phase-2-models-and-ort-web.md) | Cache Storage、ORT-web セッション、`infer()` I/F 確定 |
| 3 | Pyodide 統合 & Web Worker 化 | [phase-3-pyodide-integration.md](./phase-3-pyodide-integration.md) | Worker 化、Python ⇄ JS RPC、進捗配信 |
| 4 | フロントエンド UI 実装 | [phase-4-frontend-ui.md](./phase-4-frontend-ui.md) | D&D / 結果表示 / DL / 可視化 |
| 5 | パフォーマンス / サイズ最適化 | [phase-5-performance.md](./phase-5-performance.md) | 量子化 / WebGPU / 並列 / PWA |
| 6 | 配布・CI/CD・ドキュメント | [phase-6-release.md](./phase-6-release.md) | 本番配信、GitHub Actions、ライセンス表記 |
